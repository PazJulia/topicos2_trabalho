...
@WebServlet("/img-livro")
public class ImgLivroServlet extends HttpServlet {
	/**
	 * 
	 */
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String diretorio = System.getProperty("user.home") + File.separator + Util.PATH_IMAGES_LIVRO + File.separator;
